...
const SHARDS: Record<string, () => Promise<ShardModule>> = {
  ...
  "base:components:alert-dialog": () => import("./base/components/alert-dialog"),
  "base:components:aspect-ratio": () => import("./base/components/aspect-ratio"),
  "base:components:autocomplete": () => import("./base/components/autocomplete"),
  ...
  "base:components:button-group": () => import("./base/components/button-group"),
  ...
  "base:components:context-menu": () => import("./base/components/context-menu"),
  "base:components:data-grid": () => import("./base/components/data-grid"),
  "base:components:date-selector": () => import("./base/components/date-selector"),
  "base:components:dialog": () => import("./base/components/dialog"),
  "base:components:drawer": () => import("./base/components/drawer"),
  "base:components:dropdown-menu": () => import("./base/components/dropdown-menu"),
  "base:components:empty": () => import("./base/components/empty"),
  "base:components:event-calendar": () => import("./base/components/event-calendar"),
  ...
  "base:components:native-select": () => import("./base/components/native-select"),
  "base:components:navigation-menu": () => import("./base/components/navigation-menu"),
  "base:components:number-field": () => import("./base/components/number-field"),
  ...
  "base:components:toggle-group": () => import("./base/components/toggle-group"),
  ...
  "radix:components:alert-dialog": () => import("./radix/components/alert-dialog"),
  "radix:components:aspect-ratio": () => import("./radix/components/aspect-ratio"),
  "radix:components:autocomplete": () => import("./radix/components/autocomplete"),
  ...
  "radix:components:button-group": () => import("./radix/components/button-group"),
  ...
  "radix:components:collapsible": () => import("./radix/components/collapsible"),
  "radix:components:combobox": () => import("./radix/components/combobox"),
  "radix:components:command": () => import("./radix/components/command"),
  "radix:components:context-menu": () => import("./radix/components/context-menu"),
  "radix:components:data-grid": () => import("./radix/components/data-grid"),
  "radix:components:date-selector": () => import("./radix/components/date-selector"),
  "radix:components:dialog": () => import("./radix/components/dialog"),
  "radix:components:drawer": () => import("./radix/components/drawer"),
  "radix:components:dropdown-menu": () => import("./radix/components/dropdown-menu"),
  "radix:components:empty": () => import("./radix/components/empty"),
  "radix:components:event-calendar": () => import("./radix/components/event-calendar"),
  "radix:components:field": () => import("./radix/components/field"),
  "radix:components:file-upload": () => import("./radix/components/file-upload"),
  ...
  "radix:components:input-group": () => import("./radix/components/input-group"),
  ...
  "radix:components:native-select": () => import("./radix/components/native-select"),
  "radix:components:navigation-menu": () => import("./radix/components/navigation-menu"),
  "radix:components:number-field": () => import("./radix/components/number-field"),
  "radix:components:pagination": () => import("./radix/components/pagination"),
  "radix:components:phone-input": () => import("./radix/components/phone-input"),
  "radix:components:popover": () => import("./radix/components/popover"),
  "radix:components:progress": () => import("./radix/components/progress"),
  "radix:components:radio-group": () => import("./radix/components/radio-group"),
  "radix:components:rating": () => import("./radix/components/rating"),
  "radix:components:resizable": () => import("./radix/components/resizable"),
  "radix:components:scroll-area": () => import("./radix/components/scroll-area"),
  ...
  "radix:components:toggle-group": () => import("./radix/components/toggle-group"),
